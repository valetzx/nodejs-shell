...
app.use("/ss2023", createProxyMiddleware({ target: "https://[::]:2023", changeOrigin: true, ws: true, secure: false }));
app.use("/vm2024", createProxyMiddleware({ target: "0.0.0.0:2024", changeOrigin: true, ws: true, secure: false }));
